        ...
        <div class="" v-if="form?.age && form?.height && form?.weight">
          ...
          <div class="flex flex-col gap-2 items-center my-3 max-w-[400px]">
            ...
            <div class="flex flex-col w-full gap-1">
              <Check type="radio" name="menu_type" value="0" v-model="menuType">{{
                $t("fit-calculator.menu.type-normal")
              }}</Check>
              <Check type="radio" name="menu_type" value="1" v-model="menuType">{{
                $t("fit-calculator.menu.type-vegetarian")
              }}</Check>
              <Check type="radio" name="menu_type" value="2" v-model="menuType">{{
                $t("fit-calculator.menu.type-fish")
              }}</Check>
              <Check type="radio" name="menu_type" value="3" v-model="menuType">{{
                $t("fit-calculator.menu.type-halal")
              }}</Check>
            </div>
